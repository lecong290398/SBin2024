...
using DTKH2024.SbinSolution.Mobile.MAUI.Services.Tenants;
using DTKH2024.SbinSolution.Mobile.MAUI.Helpers;

#if ANDROID
using DTKH2024.SbinSolution.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace DTKH2024.SbinSolution.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new DTKH2024.SbinSolution.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
