...
namespace DTKH2024.SbinSolution.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameMenu
{
    public class AppAreaNameMenuViewComponent : SbinSolutionViewComponent
    {
