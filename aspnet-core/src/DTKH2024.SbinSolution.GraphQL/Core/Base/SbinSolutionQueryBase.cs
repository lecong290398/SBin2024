...
namespace DTKH2024.SbinSolution.Core.Base
{
    public abstract class SbinSolutionQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected SbinSolutionQueryBase(string fieldName,
