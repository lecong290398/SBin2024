...
using DTKH2024.SbinSolution.Web.Authentication.JwtBearer;
using DTKH2024.SbinSolution.Web.Authentication.TwoFactor;
using DTKH2024.SbinSolution.Web.Chat.SignalR;
using DTKH2024.SbinSolution.Web.Common;
using DTKH2024.SbinSolution.Web.Configuration;
...
namespace DTKH2024.SbinSolution.Web
{
    [DependsOn(
    ...
    public class SbinSolutionWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SbinSolutionWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(SbinSolutionApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SbinSolutionWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(SbinSolutionWebCoreModule).Assembly);
        }
