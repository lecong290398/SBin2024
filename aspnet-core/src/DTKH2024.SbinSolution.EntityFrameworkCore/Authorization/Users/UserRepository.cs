...
{
    public class UserRepository : SbinSolutionRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<SbinSolutionDbContext> dbContextProvider)
