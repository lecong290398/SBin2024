...
{
    public class SbinSolutionMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public SbinSolutionMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(SbinSolutionConsts.LocalizationSourceName, name);
        }
    }
}