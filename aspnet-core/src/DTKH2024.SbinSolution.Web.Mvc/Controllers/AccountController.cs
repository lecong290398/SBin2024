...
using DTKH2024.SbinSolution.Authorization.Impersonation;
...
using DTKH2024.SbinSolution.Net.Sms;
using DTKH2024.SbinSolution.Notifications;
using DTKH2024.SbinSolution.Web.Models.Account;
...
using DTKH2024.SbinSolution.Web.Authentication.External;
using DTKH2024.SbinSolution.Web.Security.Recaptcha;
using DTKH2024.SbinSolution.Web.Session;
using DTKH2024.SbinSolution.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : SbinSolutionControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(SbinSolutionConsts.DateTimeOffsetFormat));
