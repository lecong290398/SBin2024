(function ($) {
    app.modals.CreateOrEditTransactionBinModal = function () {
        ...
        var _$transactionBinInformationForm = null;
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/TransactionBins/_TransactionBinDeviceLookupTableModal.js',
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/TransactionBins/_TransactionBinTransactionStatusLookupTableModal.js',
        ...
        this.init = function (modalManager) {
            ...
            _TransactionBindeviceLookupTableModal.open({ id: transactionBin.deviceId, displayName: transactionBin.deviceName }, function (data) {
        ...
        $('#OpenUserLookupTableButton').click(function () {
            ...
            _TransactionBinuserLookupTableModal.open({ id: transactionBin.userId, displayName: transactionBin.userName }, function (data) {
        ...
        $('#OpenTransactionStatusLookupTableButton').click(function () {
            ...
            _TransactionBintransactionStatusLookupTableModal.open({ id: transactionBin.transactionStatusId, displayName: transactionBin.transactionStatusName }, function (data) {
        ...
        this.save = function () {
            ...
            if ($('#TransactionBin_TransactionStatusId').prop('required') && $('#TransactionBin_TransactionStatusId').val() == '') {
            ...
            var transactionBin = _$transactionBinInformationForm.serializeFormToObject();
			 ...
			 _transactionBinsService.createOrEdit(
				transactionBin
			 ).done(function () {
