(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaName/StatusDevices/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/StatusDevices/_CreateOrEditModal.js',
      modalClass: 'CreateOrEditStatusDeviceModal',
    });

    var _viewStatusDeviceModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaName/StatusDevices/ViewstatusDeviceModal',
