...
/// </summary>
public class SbinSolutionSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public SbinSolutionSimplePermissionDependency()
    {
    ...
    public SbinSolutionSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public SbinSolutionSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
