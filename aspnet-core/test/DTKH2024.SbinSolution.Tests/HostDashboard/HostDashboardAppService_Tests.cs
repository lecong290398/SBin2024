...
using DTKH2024.SbinSolution.MultiTenancy.HostDashboard;
...
namespace DTKH2024.SbinSolution.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SbinSolutionDbContext context, SubscriptionPayment subscriptionPayment)
        {
