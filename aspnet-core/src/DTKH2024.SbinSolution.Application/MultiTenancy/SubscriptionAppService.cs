...
{
    public class SubscriptionAppService : SbinSolutionAppServiceBase, ISubscriptionAppService
    {
        ...
        {
            return upgradeAmount < SbinSolutionConsts.MinimumUpgradePaymentAmount;
        }
