...
using DTKH2024.SbinSolution.Configuration.Host;
using DTKH2024.SbinSolution.Editions;
using DTKH2024.SbinSolution.Timing;
using DTKH2024.SbinSolution.Timing.Dto;
using DTKH2024.SbinSolution.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace DTKH2024.SbinSolution.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : SbinSolutionControllerBase
    {
