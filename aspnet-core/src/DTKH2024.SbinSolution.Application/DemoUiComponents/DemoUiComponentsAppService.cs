...
using DTKH2024.SbinSolution.DemoUiComponents.Dto;

namespace DTKH2024.SbinSolution.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SbinSolutionAppServiceBase, IDemoUiComponentsAppService
    {
