...
using DTKH2024.SbinSolution.Web.OpenIddict.Claims;
using DTKH2024.SbinSolution.Web.OpenIddict.ViewModels.Authorize;
using OpenIddict.Abstractions;
using OpenIddict.Server.AspNetCore;

namespace DTKH2024.SbinSolution.Web.OpenIddict.Controllers
{
