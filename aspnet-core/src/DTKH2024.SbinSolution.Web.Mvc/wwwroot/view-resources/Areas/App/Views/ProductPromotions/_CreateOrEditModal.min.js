(function ($) {
    app.modals.CreateOrEditProductPromotionModal = function () {
        ...
        var _$productPromotionInformationForm = null;
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/ProductPromotions/_ProductPromotionProductLookupTableModal.js',
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/ProductPromotions/_ProductPromotionCategoryPromotionLookupTableModal.js',
        ...
        this.init = function (modalManager) {
            ...
            _ProductPromotionproductLookupTableModal.open({ id: productPromotion.productId, displayName: productPromotion.productProductName }, function (data) {
        ...
        $('#OpenCategoryPromotionLookupTableButton').click(function () {
            ...
            _ProductPromotioncategoryPromotionLookupTableModal.open({ id: productPromotion.categoryPromotionId, displayName: productPromotion.categoryPromotionName }, function (data) {
        ...
        this.save = function () {
            ...
            if ($('#ProductPromotion_CategoryPromotionId').prop('required') && $('#ProductPromotion_CategoryPromotionId').val() == '') {
            ...
            var productPromotion = _$productPromotionInformationForm.serializeFormToObject();
			 ...
			 _productPromotionsService.createOrEdit(
				productPromotion
			 ).done(function () {
