...
using DTKH2024.SbinSolution.EntityFrameworkCore.Repositories;

namespace DTKH2024.SbinSolution.Organizations
{
    public class UserOrganizationUnitRepository : SbinSolutionRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<SbinSolutionDbContext> dbContextProvider)
