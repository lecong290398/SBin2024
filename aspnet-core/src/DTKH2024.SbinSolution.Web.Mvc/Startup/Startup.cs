...
using DTKH2024.SbinSolution.Web.Chat.SignalR;
using DTKH2024.SbinSolution.Web.Common;
using DTKH2024.SbinSolution.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using DTKH2024.SbinSolution.Web.Swagger;
using Stripe;
...
using DTKH2024.SbinSolution.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using DTKH2024.SbinSolution.Web.Extensions;
using DTKH2024.SbinSolution.Web.MultiTenancy;
using DTKH2024.SbinSolution.Web.OpenIddict;
using SecurityStampValidatorCallback = DTKH2024.SbinSolution.Identity.SecurityStampValidatorCallback;
...
namespace DTKH2024.SbinSolution.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<SbinSolutionWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSbinSolutionForwardedHeaders();
            }
            else
            {
            ...
            if (SbinSolutionConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "SbinSolution API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("DTKH2024.SbinSolution.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "SbinSolution API", Version = "v1"});
                ...
                var applicationXml = $"DTKH2024.SbinSolution.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"DTKH2024.SbinSolution.Web.Core.xml";
