...
using DTKH2024.SbinSolution.Web.Startup.ExternalLoginInfoProviders;
...
namespace DTKH2024.SbinSolution.Web.Startup
{
    ...
    public class SbinSolutionWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SbinSolutionWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SbinSolutionWebHostModule).GetAssembly());
        }
