...
namespace DTKH2024.SbinSolution.Web.Security.Recaptcha
{
    public class RecaptchaValidator : SbinSolutionServiceBase, IRecaptchaValidator, ITransientDependency
    {
