...
{
    public class SubscriptionPaymentRepository : SbinSolutionRepositoryBase<SubscriptionPayment, long>,
        ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<SbinSolutionDbContext> dbContextProvider)
