...
namespace DTKH2024.SbinSolution.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : SbinSolutionServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public async Task SendPasswordResetLinkAsync(User user, string link = null)
        {
            ...
            if (!link.IsNullOrEmpty())
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                    .ToString(SbinSolutionConsts.DateTimeOffsetFormat, CultureInfo.InvariantCulture));
