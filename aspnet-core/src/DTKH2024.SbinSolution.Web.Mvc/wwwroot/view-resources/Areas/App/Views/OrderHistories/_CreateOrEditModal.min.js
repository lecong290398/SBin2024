(function ($) {
    app.modals.CreateOrEditOrderHistoryModal = function () {
        ...
        var _$orderHistoryInformationForm = null;
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/OrderHistories/_OrderHistoryTransactionBinLookupTableModal.js',
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/OrderHistories/_OrderHistoryWareHouseGiftLookupTableModal.js',
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/OrderHistories/_OrderHistoryHistoryTypeLookupTableModal.js',
        ...
        this.init = function (modalManager) {
            ...
            _OrderHistoryuserLookupTableModal.open({ id: orderHistory.userId, displayName: orderHistory.userName }, function (data) {
        ...
        $('#OpenTransactionBinLookupTableButton').click(function () {
            ...
            _OrderHistorytransactionBinLookupTableModal.open({ id: orderHistory.transactionBinId, displayName: orderHistory.transactionBinTransactionCode }, function (data) {
        ...
        $('#OpenWareHouseGiftLookupTableButton').click(function () {
            ...
            _OrderHistorywareHouseGiftLookupTableModal.open({ id: orderHistory.wareHouseGiftId, displayName: orderHistory.wareHouseGiftCode }, function (data) {
        ...
        $('#OpenHistoryTypeLookupTableButton').click(function () {
            ...
            _OrderHistoryhistoryTypeLookupTableModal.open({ id: orderHistory.historyTypeId, displayName: orderHistory.historyTypeName }, function (data) {
        ...
        this.save = function () {
            ...
            var orderHistory = _$orderHistoryInformationForm.serializeFormToObject();
			 ...
			 _orderHistoriesService.createOrEdit(
				orderHistory
			 ).done(function () {
