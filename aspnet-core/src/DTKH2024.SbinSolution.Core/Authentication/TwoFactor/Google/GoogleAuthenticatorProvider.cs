...
namespace DTKH2024.SbinSolution.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SbinSolutionServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("DTKH2024.SbinSolution", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
