...
namespace DTKH2024.SbinSolution.OpenIddict.Applications
{
    public class EfCoreOpenIddictApplicationRepository : SbinSolutionRepositoryBase<OpenIddictApplication, Guid>,
