...
namespace DTKH2024.SbinSolution.Web.Areas.AppAreaName.Views.Shared.Themes.Theme7.Components.AppAreaNameTheme7Brand
{
    public class AppAreaNameTheme7BrandViewComponent : SbinSolutionViewComponent
    {
