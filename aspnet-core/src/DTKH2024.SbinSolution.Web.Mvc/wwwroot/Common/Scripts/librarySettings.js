(function () {
  ...
  if (abp.libs.sweetAlert) {
    ...
    abp.libs.sweetAlert.config.confirm.confirmButtonText = abp.localization.localize('Yes', 'SbinSolution');
    abp.libs.sweetAlert.config.confirm.cancelButtonText = abp.localization.localize('Cancel', 'SbinSolution');
