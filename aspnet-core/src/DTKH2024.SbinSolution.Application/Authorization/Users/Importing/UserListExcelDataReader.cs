...
namespace DTKH2024.SbinSolution.Authorization.Users.Importing
{
    ...
    {
        private readonly ILocalizationSource _localizationSource = localizationManager.GetSource(SbinSolutionConsts.LocalizationSourceName);
