...
using DTKH2024.SbinSolution.Web.Models.TokenAuth;
...
namespace DTKH2024.SbinSolution.Web.Controllers
{
    ...
    public class TokenAuthController : SbinSolutionControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(SbinSolutionConsts.DateTimeOffsetFormat));
