...
namespace DTKH2024.SbinSolution.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SbinSolutionAppServiceBase, IDashboardCustomizationAppService
    {
