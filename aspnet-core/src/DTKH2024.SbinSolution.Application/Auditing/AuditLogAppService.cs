...
using DTKH2024.SbinSolution.Auditing.Exporting;
...
using EntityHistoryHelper = DTKH2024.SbinSolution.EntityHistory.EntityHistoryHelper;

namespace DTKH2024.SbinSolution.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SbinSolutionAppServiceBase, IAuditLogAppService
    {
