...
using DTKH2024.SbinSolution.DashboardCustomization.Definitions.Cache;

namespace DTKH2024.SbinSolution.DashboardCustomization.Definitions
{
    public class DashboardConfiguration : ITransientDependency
    {
            ...
            IAbpSession abpSession)
        {
            ...
            var simplePermissionDependencyForTenantDashboard =
                new SbinSolutionSimplePermissionDependency(AppPermissions.Pages_Tenant_Dashboard);
            ...
            var generalStats = new WidgetDefinition(
                ...
                "WidgetGeneralStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: new SbinSolutionSimplePermissionDependency(
                    requiresAll: true,
            ...
            var simplePermissionDependencyForHostDashboard =
                new SbinSolutionSimplePermissionDependency(AppPermissions.Pages_Administration_Host_Dashboard);
            ...
            var defaultTenantDashboard = new DashboardDefinition(
                SbinSolutionDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                new List<string>
                {
            ...
            var defaultHostDashboard = new DashboardDefinition(
                SbinSolutionDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                new List<string>
                {
                    incomeStatistics.Id,
                    hostTopStats.Id,
