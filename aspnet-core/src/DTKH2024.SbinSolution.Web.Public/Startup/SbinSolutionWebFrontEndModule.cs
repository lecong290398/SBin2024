...
namespace DTKH2024.SbinSolution.Web.Public.Startup
{
    [DependsOn(
        typeof(SbinSolutionWebCoreModule)
    )]
    public class SbinSolutionWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SbinSolutionWebFrontEndModule(IWebHostEnvironment env, SbinSolutionEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SbinSolutionWebFrontEndModule).GetAssembly());
        }
    }
}
