(function () {
  $(function () {
    ...
    var _excelExportModal = new app.ModalManager({
        viewUrl: abp.appPath + 'App/Users/ExcelExportModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Users/_ExcelExportModal.js',
              ...
              },
              {
                ...
                visible: function () {
                  return _dynamicEntityPropertyManager.canShow(
                    'DTKH2024.SbinSolution.Authorization.Users.User'
                  );
                },
                action: function (data) {
                  _dynamicEntityPropertyManager.modal.open({
                    entityFullName: 'DTKH2024.SbinSolution.Authorization.Users.User',
    ...
    $('#ImportUsersFromExcelButton')
      .fileupload({
        url: abp.appPath + 'App/Users/ImportFromExcel',
        dataType: 'json',
