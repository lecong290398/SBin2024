...
namespace DTKH2024.SbinSolution.OpenIddict.Authorizations
{
    public class EfCoreOpenIddictAuthorizationRepository : SbinSolutionRepositoryBase<OpenIddictAuthorization, Guid>,
