...
namespace DTKH2024.SbinSolution.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SbinSolutionAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SbinSolutionDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{SbinSolutionConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{SbinSolutionConsts.ConnectionStringName}", constring);
        }
