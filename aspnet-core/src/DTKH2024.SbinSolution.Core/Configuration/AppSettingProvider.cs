...
using DTKH2024.SbinSolution.Authentication;
...
namespace DTKH2024.SbinSolution.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!SbinSolutionConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        SbinSolutionConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        SbinSolutionDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        SbinSolutionDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = SbinSolutionDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{SbinSolutionDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{SbinSolutionDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = SbinSolutionDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = SbinSolutionDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    SbinSolutionDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = SbinSolutionDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{SbinSolutionDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{SbinSolutionDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = SbinSolutionDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = SbinSolutionDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    SbinSolutionDashboardCustomizationConsts.Widgets.Tenant
