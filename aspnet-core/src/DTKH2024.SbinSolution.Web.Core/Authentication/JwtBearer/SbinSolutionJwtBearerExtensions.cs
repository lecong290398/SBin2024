...
/// </summary>
public static class SbinSolutionJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, SbinSolutionAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
