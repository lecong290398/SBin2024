...
{
    public class SbinSolutionAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public SbinSolutionAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
