(function ($) {
    app.modals.CreateOrEditWareHouseGiftModal = function () {
        ...
        var _$wareHouseGiftInformationForm = null;
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/WareHouseGifts/_WareHouseGiftProductPromotionLookupTableModal.js',
        ...
        this.init = function (modalManager) {
            ...
            _WareHouseGiftuserLookupTableModal.open({ id: wareHouseGift.userId, displayName: wareHouseGift.userName }, function (data) {
        ...
        $('#OpenProductPromotionLookupTableButton').click(function () {
            ...
            _WareHouseGiftproductPromotionLookupTableModal.open({ id: wareHouseGift.productPromotionId, displayName: wareHouseGift.productPromotionPromotionCode }, function (data) {
        ...
        this.save = function () {
            ...
            if ($('#WareHouseGift_ProductPromotionId').prop('required') && $('#WareHouseGift_ProductPromotionId').val() == '') {
            ...
            var wareHouseGift = _$wareHouseGiftInformationForm.serializeFormToObject();
			 ...
			 _wareHouseGiftsService.createOrEdit(
				wareHouseGift
			 ).done(function () {
