...
using DTKH2024.SbinSolution.Authorization.Ldap;
...
using DTKH2024.SbinSolution.DashboardCustomization.Definitions;
using DTKH2024.SbinSolution.Debugging;
...
using DTKH2024.SbinSolution.Localization;
using DTKH2024.SbinSolution.MultiTenancy;
using DTKH2024.SbinSolution.Net.Emailing;
using DTKH2024.SbinSolution.Notifications;
using DTKH2024.SbinSolution.WebHooks;

namespace DTKH2024.SbinSolution
{
    [DependsOn(
        typeof(SbinSolutionCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class SbinSolutionCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            SbinSolutionLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = SbinSolutionConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, SbinSolutionMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<SbinSolutionSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SbinSolutionCoreModule).GetAssembly());
        }
