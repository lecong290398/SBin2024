...
namespace DTKH2024.SbinSolution.Web.Areas.AppAreaName.Views.Shared.Themes.Theme8.Components.AppAreaNameTheme8Brand
{
    public class AppAreaNameTheme8BrandViewComponent : SbinSolutionViewComponent
    {
