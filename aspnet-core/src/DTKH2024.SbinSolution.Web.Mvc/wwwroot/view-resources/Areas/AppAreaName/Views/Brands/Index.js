(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaName/Brands/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppAreaName/Views/Brands/_CreateOrEditModal.js',
      modalClass: 'CreateOrEditBrandModal',
    });

    var _viewBrandModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppAreaName/Brands/ViewbrandModal',
