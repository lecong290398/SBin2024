(function ($) {
    app.modals.CreateOrEditBenefitsRankLevelModal = function () {
        ...
        var _$benefitsRankLevelInformationForm = null;
            ...
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/BenefitsRankLevels/_BenefitsRankLevelRankLevelLookupTableModal.js',
        ...
        this.init = function (modalManager) {
            ...
            _$benefitsRankLevelInformationForm = _modalManager.getModal().find('form[name=BenefitsRankLevelInformationsForm]');
            ...
            _BenefitsRankLevelrankLevelLookupTableModal.open({ id: benefitsRankLevel.rankLevelId, displayName: benefitsRankLevel.rankLevelName }, function (data) {
        ...
        this.save = function () {
            ...
            var benefitsRankLevel = _$benefitsRankLevelInformationForm.serializeFormToObject();
			 ...
			 _benefitsRankLevelsService.createOrEdit(
				benefitsRankLevel
			 ).done(function () {
