...
using DTKH2024.SbinSolution.Web.Areas.AppAreaName.Models.Languages;
...
namespace DTKH2024.SbinSolution.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : SbinSolutionControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = SbinSolutionConsts.LocalizationSourceName;
            }
