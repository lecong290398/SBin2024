...
using DTKH2024.SbinSolution.Web.Public.Startup;
using DTKH2024.SbinSolution.Web.Session;
using DTKH2024.SbinSolution.Web.UiCustomization;

namespace DTKH2024.SbinSolution.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SbinSolutionViewComponent
    {
